...
from Model.NetworkSniffer import NetworkSnifer
...
class NetworkHostsDataGridContainer(wx.ScrolledWindow):
    """A scrolled window, holding a sizer, holding a DataGrid,
     contains all bindings to update grid based on data source."""
    def __init__(self, parentPanel, dataSource: NetworkSnifer, *args, **kwargs):
